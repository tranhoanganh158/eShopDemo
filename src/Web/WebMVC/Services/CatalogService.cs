...
public class CatalogService : ICatalogService
{
    ...
    public async Task<Catalog> GetCatalogItems(int page, int take, int? brand, int? type)
    {
        ...
        //    eventLog.WriteEntry($"{page}", EventLogEntryType.Information);
        //    eventLog.WriteEntry($"{take}", EventLogEntryType.Information);
        //    eventLog.WriteEntry($"{brand}", EventLogEntryType.Information);
        //    eventLog.WriteEntry($"{type}", EventLogEntryType.Information);
        //    eventLog.WriteEntry($"{uri}", EventLogEntryType.Information);
